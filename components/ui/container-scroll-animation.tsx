...
export const ContainerScroll = ({
  ...
  // Use more granular input/output ranges for smoother transitions
  const rotate = useTransform(scrollYProgress, [0, 0.2, 0.5, 1], [20, 10, 5, 0])
  const scale = useTransform(scrollYProgress, [0, 0.2, 0.5, 1], [...scaleDimensions(), ...scaleDimensions().reverse()])
  const translate = useTransform(scrollYProgress, [0, 0.2, 0.5, 1], [0, -30, -70, -100])
